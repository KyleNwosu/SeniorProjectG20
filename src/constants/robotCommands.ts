...
export const TASK_ACTION_LABELS: Record<RobotCommand, string> = {
  ...
  move_up:       "Move Up",
  move_down:     "Move Down",
  rotate_left:   "Rotate Left (Wrist Roll)",
  rotate_right:  "Rotate Right (Wrist Roll)",
...
export const CONTROL_COMMANDS = {
  ...
  baseRotateLeft:    { type: "base_rotate_left",   label: "Rotating Base Left"   },
  baseRotateRight:   { type: "base_rotate_right",  label: "Rotating Base Right"  },
